                        ...
                        <div class="modal-body">
                            <form name="frmPrecios" class="form-horizontal" novalidate="">
                                ...
                                <div class="form-group error">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control has-error" id="slCanton" ng-model="precio.idCanton" ng-required="true" ng-change="obtenerDistritos(precio.idCanton)" >
                                ...
                                <div class="form-group error">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control has-error" id="slDistrito" ng-model="precio.idDistrito" ng-required="true">
