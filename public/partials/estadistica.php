	...
	<nav class="navbar navbar-default nav-stacked">
            <div class="conteiner-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Evolución de precios de productos</a>
                </div>

                <div class="collapse navbar-collapse" id="myBar2">
                    <ul class="nav navbar-nav" style="padding-top: 8px;">
	                    <select class="form-control" id="slETipoProducto" ng-model="id_tipo_producto" ng-required="true" ng-change="obtenerProductos(id_tipo_producto)">
	                    	<option value="">---Seleccione un Tipo de Producto---</option>
	                    	<option ng-repeat="tipoProducto in tiposProducto" value="{{ tipoProducto.id }}">{{ tipoProducto.nombre }}</option>
	                    </select>
                    </ul>
                    <ul class="nav navbar-nav" style="padding-top: 8px;">
	                    <select class="form-control" id="slEProducto" ng-model="id_producto" ng-required="true">
