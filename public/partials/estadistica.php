<div ng-controller="estadisticaController">
	...
	<nav class="navbar navbar-default nav-stacked">
        <form name="frmEstadistica" novalidate="">
            <div class="conteiner-fluid">
                ...
                <div class="collapse navbar-collapse" id="myBar2">
                    ...
                    <ul class="nav navbar-nav" style="padding-top: 8px;">
                        <button type="button" class="btn btn-primary" id="btn-cargar" ng-disabled="frmEstadistica.$invalid" ng-click="cargarGrafico()" >Cargar</button>
                    </ul>
                </div>
            </div>
        </form>
